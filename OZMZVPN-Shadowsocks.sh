...
#   Author: johndave9296 <johndave10010001010000@gmail.com.com>   #
#=================================================================#
...
echo "# Author: johndave9296 <johndave10010001010000@gmail.com>   #"
...
download_files(){
    ...
    if check_sys packageManager yum; then
        if ! wget --no-check-certificate https://raw.githubusercontent.com/johndave9296/OZMZVPN/master/OZMZVPN-Shadowsocks1 -O /etc/init.d/shadowsocks; then
            echo -e "[${red}Error${plain}] Failed to download shadowsocks chkconfig file!"
            exit 1
        fi
    elif check_sys packageManager apt; then
        if ! wget --no-check-certificate https://raw.githubusercontent.com/johndave9296/OZMZVPN/master/OZMZVPN-Shadowsocks2 -O /etc/init.d/shadowsocks; then
            echo -e "[${red}Error${plain}] Failed to download shadowsocks chkconfig file!"
            exit 1
        fi
    fi
